...
export const QUICK_ACTIONS: QuickAction[] = [
  { label: 'Produk Tabungan', text: 'Saya ingin tahu tentang produk tabungan berjangka yang Anda miliki.' },
  { label: 'Transfer Dana', text: 'Tolong transfer Rp 2.500.000 ke rekening tujuan 987654321.' },
  { label: 'Ubah Alamat', text: 'Saya ingin mengubah alamat surat menyurat saya menjadi Jl. Sudirman No. 12 Jakarta.' },
  { label: 'Cek Saldo (CSA Test)', text: 'Berapa saldo saya saat ini?' },
  { label: 'Laporan Transaksi', text: 'Buatkan saya ringkasan transaksi bulan lalu.' }
];
